...
_serverInfoString = format ["<t color='#A0FFFFFF'>Total Punishment Gaming - WASTELAND!</t>", call A3W_extDB_ServerID, worldName];
...
_generalInfoString = "Website/Forums: <t color='#0091CD'><a href='http://totalpunishmentgaming.com'>TotalPunishmentGaming.com</a></t> TeamSpeak: ts3.totalpunishmentgaming.com";
