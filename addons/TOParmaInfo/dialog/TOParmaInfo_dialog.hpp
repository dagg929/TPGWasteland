...
class TOParmaInfoD
{
	...
	{	
		...
		{
			idc = 10032;
			text = "TotalPunishmentGaming.com";
		...
		class TAGeneralInfoBackground: RscText
		{
			...
			type = CT_STRUCTURED_TEXT;
			size = 0.030;
			text = "Website: TotalPunishmentGaming.com TeamSpeak: ts3.totalpunishmentgaming.com";
			x = "0 * (((safezoneW / safezoneH) min 1.2) / 40)";
		...
		class TAStatsTiTleBackground: RscText
		{
			...
			text = "]TPG[ Player and Server stats COMING SOON";
			x = "15.1 * (((safezoneW / safezoneH) min 1.2) / 40)";
